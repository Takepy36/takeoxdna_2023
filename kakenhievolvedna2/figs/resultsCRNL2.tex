...
% L2
\node[inner sep=0] (E) {\includegraphics[width=10cm]{../results/graphAnalyses50/E_random-overlap2.png}};
\node[inner sep=0, below=0mm of E] (Ecbar) {\includegraphics[width=10cm]{../results/graphAnalyses50/E_random-overlap2-cbar.png}};
\node[inner sep=0, below=0mm of Ecbar] (F) {\includegraphics[width=10cm]{../results/graphAnalyses50/F_GA-overlap2.png}};
\node[inner sep=0, below=0mm of F] (Fcbar) {\includegraphics[width=10cm]{../results/graphAnalyses50/F_GA-overlap2-cbar.png}};
\node[inner sep=0, below=0mm of Fcbar] (G) {\includegraphics[width=10cm]{../results/graphAnalyses50/G_GA-overlap2.png}};
\node[inner sep=0, below=0mm of G] (Gcbar) {\includegraphics[width=10cm]{../results/graphAnalyses50/G_GA-overlap2-cbar.png}};
\node[inner sep=0, below=0mm of Gcbar] (H) {\includegraphics[width=10cm]{../results/graphAnalyses50/H_random-overlap2.png}};
\node[inner sep=0, below=0mm of H] (Hcbar) {\includegraphics[width=10cm]{../results/graphAnalyses50/H_random-overlap2-cbar.png}};


% Titles
\node[color=black,left=0.5mm of E,rotate=0,anchor=north,align=center,shift={(0.00,0.00)}] {\Large{E}};
\node[color=black,left=0.5mm of F,rotate=0,anchor=north,align=center,shift={(0.00,0.00)}] {\Large{F}};
\node[color=black,left=0.5mm of G,rotate=0,anchor=north,align=center,shift={(0.00,0.00)}] {\Large{G}};
\node[color=black,left=0.5mm of H,rotate=0,anchor=north,align=center,shift={(0.00,0.00)}] {\Large{H}};
