...
if [ "$executionMode" = "normal" ]; then
    exec gosu user bash -c "cd /home/user/kakenhievolvedna; ln -s /home/user/results results; export PATH=\$PATH:/usr/local/bin; nice ./scripts/illuminate.py $@; rsync -avz /home/user/results/ /home/user/finalresults/"
    ...
    exec gosu user bash -c "cd /home/user/kakenhievolvedna; ln -s /home/user/results results; export PATH=\$PATH:/usr/local/bin; python3 -m scoop --hostfile $hostsFilePath ./scripts/illuminate.py $@; rsync -avz /home/user/results/ /home/user/finalresults/"
fi
