...
def dot (a, b):
    if not (isinstance (a, array) and isinstance (b, array)):
        return NotImplemented
        #return [NotImplemented,[a, array, isinstance (a, array)],[b, array, isinstance (b, array)]]
    ...
    if a.isnumbers and b.isnumbers:
        ...
        return NotImplemented
        #return [NotImplemented,isinstance (a, array),isinstance (b, array),a.length, b.length, a.isnumbers, b.isnumbers, a.isarray, b.isarray]
