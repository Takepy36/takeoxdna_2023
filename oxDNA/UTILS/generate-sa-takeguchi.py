...
def read_strands(filename):
    ...
    try:
        ...
        out = open(output_name + ".top","w")
    except:
        print >> sys.stderr, "Could not open topology file for writing. Aborting"
        sys.exit(4)
    ...
    try:
        ...
        outfile = open(output_name + ".dat","w")
    except:
        print >> sys.stderr, "Could not open dat file for writing.  Aborting"
        sys.exit(5)
    ...
    outfile.close()
    print >> sys.stderr, "## ALL DONE. just generated dat file and topology file"
