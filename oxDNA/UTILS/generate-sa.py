...
try:
    ...
    print >> sys.stderr, "Usage: %s <%s> <%s> <%s>" % (sys.argv[0], "box size", "file with sequences", "basename")
    sys.exit(1)
...
def read_strands(filename):
    ...
    outfile.close()
    print >> sys.stderr, "## ALL DONE. just generated '" + basename + ".dat' and '" + basename +  ".top'"
